pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/VmDeployment'                                   //<-----change this to your MiamiID!
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/hunterds-miamioh/Vm-Auto-Deployment-.git'     //<-----change this to match this new repository!
